...
BOOL CMyListCtrl::OnEraseBkgnd(CDC* pDC)
{
	...
	pDC->TransparentBlt(clientRect.left,clientRect.top,clientRect.right-clientRect.left+21,clientRect.bottom-clientRect.top+5,&bitmapDC,0,0,clientRect.right-clientRect.left,clientRect.bottom-clientRect.top,SRCCOPY);
 ...
 void CMyListCtrl::OnLButtonUp(UINT nFlags, CPoint point)
{
	...
	CWnd::FromHandle(m_viewHandle)->SendMessage(WM_LBTUP,nFlags,(LPARAM)&point);
}
