...
//机器定义
#ifndef _DEBUG
#define ANDROID_SERVICE_DLL_NAME	TEXT("SupremeAndroid.dll")	//组件名字
#else
#define ANDROID_SERVICE_DLL_NAME	TEXT("SupremeAndroid.dll")	//组件名字
#endif
...
//	lstrcpyn(m_GameServiceAttrib.szDescription,TEXT("游戏服务组件"),CountArray(m_GameServiceAttrib.szDescription));
	lstrcpyn(m_GameServiceAttrib.szClientEXEName,TEXT("Supreme.EXE"),CountArray(m_GameServiceAttrib.szClientEXEName));
	lstrcpyn(m_GameServiceAttrib.szServerDLLName,TEXT("SupremeServer.DLL"),CountArray(m_GameServiceAttrib.szServerDLLName));
